...
/***/ "./modules/searchService.js":
/*!**********************************!*\
  !*** ./modules/searchService.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _getData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getData */ \"./modules/getData.js\");\n/* harmony import */ var _renderData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderData */ \"./modules/renderData.js\");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers */ \"./modules/helpers.js\");\n\n\n\n\nconst searchService = (url) => {\n    const selector = document.getElementById('typeItem')\n    const input = document.getElementById('search-input');\n\n    let currentType;\n\n    const debounceSearch = (0,_helpers__WEBPACK_IMPORTED_MODULE_2__.debounce)(() => {\n        (0,_getData__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(url)\n            .then(data => {\n                currentType = selector.options[selector.selectedIndex].innerHTML;\n\n                if (currentType === 'Все услуги') {\n                    (0,_renderData__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(data.filter((el) => { return el.type.toLowerCase().includes(input.value.toLowerCase()) || el.name.toLowerCase().includes(input.value.toLowerCase()) }))\n                } else {\n                    let list = data.filter((item) => item.type === currentType);\n                    (0,_renderData__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(list.filter((el) => { return el.type.toLowerCase().includes(input.value.toLowerCase()) || el.name.toLowerCase().includes(input.value.toLowerCase()) }))\n                };\n            })\n    }, 500);\n\n    input.addEventListener('input', debounceSearch);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (searchService);\n\n//# sourceURL=webpack:///./modules/searchService.js?");
